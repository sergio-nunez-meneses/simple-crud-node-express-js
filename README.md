...
### Open the [backend](https://github.com/sergio-nunez-meneses/simple-crud-node-express-js/tree/master/backend) folder to see my solution, or follow the steps of the [README.md](https://github.com/sergio-nunez-meneses/simple-crud-node-express-js/blob/master/backend/README.md) file to setup the base backend structure ###
